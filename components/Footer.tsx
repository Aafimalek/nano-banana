...
export const Footer: React.FC = () => {
    ...
    const tools = ["Mockups", "Brand Assets", "Recipes", "Text Effects", "Diagrams", "Storybooks"];
    ...
    return (
        <footer className="bg-zinc-100 dark:bg-zinc-950/50 border-t border-zinc-200 dark:border-zinc-800/50">
            <div className="mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            {tools.map(tool => (
                                <li key={tool}>
                                    <span className="text-base text-zinc-500 dark:text-zinc-400 hover:text-teal-500 transition-colors">{tool}</span>
                                </li>
                            ))}
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            <li>
                                <a href="#" className="flex items-center space-x-2 text-base text-zinc-500 dark:text-zinc-400 hover:text-teal-500 transition-colors">
                ...
                <div className="mt-12 pt-8 border-t border-zinc-200 dark:border-zinc-800 text-center text-base text-zinc-500 dark:text-zinc-400">
